...
#GETTING STARTED WITH SCULPT PROJECT
...
Elastic Search - 5.x
 ...
 - uncomment "network.host: 192.168.0.1" and update IP to local IP address
 - sudo systemctl daemon-reload
 - sudo systemctl enable elasticsearch
 - sudo systemctl restart elasticsearch
 - sudo /etc/init.d/elasticsearch restart|stop|start... [Optional]
